...
namespace NewInfiniteResources_DLC.src
{
    ...
    public class LightConfig : IBuildingConfig, IContentInfo
    {
        ...
        public ContentBasicInfo GetContentBasicInfo() =>
             ...
             {
                 ID = "NewISLight",
                 DisplayName = InfiniteReg.language.Equals("schinese") ? "吊顶日光灯": "Utility light",
                 Description = InfiniteReg.language.Equals("schinese") ? "亮就完事了!": "Because Everyone Loves Salt Lamps!",
                 Effect = InfiniteReg.language.Equals("schinese") ? "能亮瞎复制人的24K钛合金眼!": "I can see it from all the way over there!",
                 Category = "Furniture"
             };
