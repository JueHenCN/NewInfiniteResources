...
namespace NewInfiniteResources_DLC.src
{
    ...
    public class InfiniteStorageConfig : IBuildingConfig,IContentInfo
    {
        public ContentBasicInfo GetContentBasicInfo() => new ContentBasicInfo
        {
            ID = "InfiniteStorage",
            DisplayName = InfiniteReg.language.Equals("schinese") ? "量子储物柜" : "Infinite Storage",
            Description = InfiniteReg.language.Equals("schinese") ? "遇事不决,量子力学!" : "All the Items!.",
            Effect = InfiniteReg.language.Equals("schinese") ? "无限生成物品的箱子!" : "Everytime you open it, theres more!",
            Category = "Base",
        };
